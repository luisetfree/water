...
/**
Funcion que busca las horas que ya fueron ingresadas durante el dia, para mostrar en el select de la vista RESUMEN las horas que faltan por ingresar
*/
public function buscarHora($fecha,$hora,$id_quimico){
